...
function bootstrapCommonMakesIfEmpty() {
  ...
  const common = [
    "Chevrolet","GMC","Kia","Ram","Toyota","Honda","Nissan","Hyundai","Kia",
    "Jeep","Volkswagen","Subaru","Kia","BMW","Mercedes-Benz","Audi","Dodge",
...
(function i18nFull(){
  ...
  const MAP_EN_ES = new Map([
    ...
    ["backToDealer", "Volver a Quirk Hyundai"],
    ["successTitle", "¡Gracias! - Quirk Hyundai"],
    ["successHeading", "¡Gracias!"],
    ["successMessage", "Hemos recibido los detalles de su intercambio. Un especialista de Quirk Hyundai se pondrá en contacto con usted en breve."]
  ]);
